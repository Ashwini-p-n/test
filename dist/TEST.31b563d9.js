...
})({"7jy38":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 5173;
...
var _webSdk = require("@moengage/web-sdk");
var _webSdkDefault = parcelHelpers.interopDefault(_webSdk);
// 2. INITIALIZE the SDK
const MOENGAGE_APP_ID = 'ILHCGEFZ04ELWYTI71A01OW2';
(0, _webSdkDefault.default).initialize({
    app_id: MOENGAGE_APP_ID,
    cluster: 'DC_3',
...
(0, _webSdkDefault.default).call_web_push();
...
if (loginButton) loginButton.addEventListener("click", ()=>{
    ...
    (0, _webSdkDefault.default).add_email(email);
...
const Moe = {
    ...
    add_unique_user_id: (e)=>Moe.isMoeLoaded() && window.Moengage.add_unique_user_id(e),
    update_unique_user_id: (e)=>Moe.isMoeLoaded() && window.Moengage.update_unique_user_id(e),
    identifyUser: (e)=>Moe.isMoeLoaded() && window.Moengage.identifyUser(e),
    getUserIdentities: ()=>Moe.isMoeLoaded() && window.Moengage.getUserIdentities(),
    enableSdk: ()=>Moe.isMoeLoaded() && window.Moengage.enableSdk(),
    disableSdk: ()=>Moe.isMoeLoaded() && window.Moengage.disableSdk(),
    isSdkEnabled: ()=>Moe.isMoeLoaded() && window.Moengage.isSdkEnabled(),
    getUserId: ()=>Moe.isMoeLoaded() && window.Moengage.getUserId(),
    getUserAttribute: (e, o)=>Moe.isMoeLoaded() ? o && "string" == typeof o ? window.Moengage.getUserAttribute(e, o) : window.Moengage.getUserAttribute(e) : null,
    add_user_attribute: (e, o, d)=>!!Moe.isMoeLoaded() && (d && "string" == typeof d ? window.Moengage.add_user_attribute(e, o, d) : window.Moengage.add_user_attribute(e, o)),
    ...
    handle_page_change: ()=>Moe.isMoeLoaded() && window.Moengage.handle_page_change(),
    on_cards_loaded: ()=>new Promise((e, o)=>{
            "undefined" != typeof window ? window.Moengage.cards ? (Moe.cards = window.Moengage.cards, e()) : window.addEventListener("MOE_LIFECYCLE", (o)=>{
                "CARDS_INITIALIZED" === o.detail.name && (Moe.cards = window.Moengage.cards, e());
            }) : o();
        }),
    cards: "undefined" != typeof window && window.Moengage && window.Moengage.cards || {},
    onsite: {
        getData: ()=>Moe.isMoeLoaded() && window.Moengage.onsite.getData(),
        registerCallback: (e)=>Moe.isMoeLoaded() && window.Moengage.onsite.registerCallback(e),
        getSelfHandledOSM: (e)=>Moe.isMoeLoaded() && window.Moengage.onsite.getSelfHandledOSM(e),
        selfHandledShown: (e)=>Moe.isMoeLoaded() && window.Moengage.onsite.selfHandledShown(e),
        selfHandledClicked: (e)=>Moe.isMoeLoaded() && window.Moengage.onsite.selfHandledClicked(e),
        selfHandledDismissed: (e)=>Moe.isMoeLoaded() && window.Moengage.onsite.selfHandledDismissed(e)
    },
    Attribute: {
...
},{}]},["7jy38","a0t4e"], "a0t4e", "parcelRequire94c2", {})

//# sourceMappingURL=TEST.31b563d9.js.map
